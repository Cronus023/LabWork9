	...
	<table>
		...
		<tr bgcolor="#cccccc" align="center">
			...
			<a href="<c:url value="${pageContext.request.requestURL}">
                ...
                <img src="<c:url value="https://w7.pngwing.com/pngs/968/419/png-transparent-arrow-computer-icons-down-arrow-hand-window-desktop-wallpaper.png"/>"
		...
		<c:forEach items="${adListing}" var="ad">
			<tr valign="top">
				<td>
					...
					<a
					href="<c:url value="/viewAd.jsp"><c:param name="id" value="${ad.id}" />
                        </c:url>"><c:out
							value="${ad.subject}" /></a>
